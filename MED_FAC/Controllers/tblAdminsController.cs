...
namespace MED_FAC.Controllers
{
    public class tblAdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ADMIN_ID,ADMIN_NAME,ADMIN_EMAIL,ADMIN_PASSWORD,ADMIN_CONTACT")] tblAdmin tblAdmin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ADMIN_ID,ADMIN_NAME,ADMIN_EMAIL,ADMIN_PASSWORD,ADMIN_CONTACT")] tblAdmin tblAdmin)
        {
            if (ModelState.IsValid)
            {
